...
import (
	...
	secretsv1alpha1 "example.com/pg/apis/secrets/v1alpha1"
...
//+kubebuilder:rbac:groups=secrets.example.com,resources=secrets,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=secrets.example.com,resources=secrets/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=secrets.example.com,resources=secrets/finalizers,verbs=update
...
func (r *SecretReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err := r.Get(ctx, req.NamespacedName, &object); err != nil {
		if errors.IsNotFound(err) {
			...
			obj := specs.BuildSecret(req.Namespace, &resource)
